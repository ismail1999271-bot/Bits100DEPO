"""News/KAP normalization contracts.

Network clients are intentionally kept in adapters; credentials and provider-specific
APIs must be configured separately and never hard-coded in the strategy layer.
"""
...
__all__ = ["EventType", "NewsEvent", "deduplicate_events"]
